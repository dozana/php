...
?>
  <tr>
    ...
    <td align="center">
      <!--
      <a href="delete.php?CusID=<?php //echo $objResult["CustomerID"];?>">Delete</a>
      -->
    
      <a href="JavaScript:if(confirm('Confirm Delete?') == true){window.location='delete.php?CusID=<?php echo $objResult["CustomerID"];?>';}">Delete</a>
    </td>
  </tr>
<?php
}
