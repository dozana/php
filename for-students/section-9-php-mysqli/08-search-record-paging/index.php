...
<head>
  ...
  <title>Search Record Paging</title>
...
<div class="container">
  <div class="row my-4">
    <div class="col-md-12">
      ...
      <h3 class="mb-3">Search Record Paging</h3>
      ...
      if(isset($_GET['txtKeyword'])) {
        ...
        <?php
        if ($prevPage) {
            echo " <a href='$_SERVER[SCRIPT_NAME]?page=$prevPage&txtKeyword=" . urlencode($_GET['txtKeyword']) . "'><< Back</a> ";
        }
        
        for ($i = 1; $i <= $numPages; $i++) {
            if ($i != $page) {
                echo "[ <a href='$_SERVER[SCRIPT_NAME]?page=$i&txtKeyword=" . urlencode($_GET['txtKeyword']) . "'>$i</a> ]";
            } else {
                echo "<b> $i </b>";
            }
        }
        ...
        if ($page != $numPages) {
            echo " <a href ='$_SERVER[SCRIPT_NAME]?page=$nextPage&txtKeyword=" . urlencode($_GET['txtKeyword']) . "'>Next>></a> ";
        }
        mysqli_close($conn);
      }
      ?>
